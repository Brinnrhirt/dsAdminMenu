Locales['es'] = {
        ...
        info = {
            ...
            ["check_discord"] = "🔸 Revisa nuestro Discord para más información: %s",
            ["banned"] = "Has sido baneado por: %s",
            ["ban_perm"] = "\n\nTu banneo es permanente.\n🔸 Revisa nuestro Discord para más información: ",
            ["ban_expires"] = "\n\n Tu Ban expira en: ",
            ["rank_level"] = "Su nivel de permiso es ahora: %s ",
            ...
            ['entity_view_distance'] = "Distancia de visualización de la entidad establecida en: %s metros",
            ...
            ["join_server"] = 'Bienvenid@ al Servidor, %s.',
        },
        menu = {
        ...
        desc = {
            ...
            ["giveperms_desc"] = "Give the permission group",
        },
        time = {
            ...
            ["self"] = "Uno mismo",
            ["changed"] = "El tiempo cambió a %s hrs 00 min",
        },
        weather = {
        ...
        commands = {
            ["blips_for_player"] = "Mostrar blips para los jugadores",
            ["player_name_overhead"] = "Mostrar el nombre del jugador en la parte superior",
            ["coords_dev_command"] = "Habilitar visualización de coordenadas para material de desarrollo",
            ["toogle_noclip"] = "Alternar noclip",
            ["make_announcement"] = "Hacer un anuncio",
            ["open_admin"] = "Abrir menú de administración",
            ["staffchat_message"] = "Enviar un mensaje a todo el personal",
            ["nui_focus"] = "Give A Player NUI Focus",
            ["warn_a_player"] = "Advertir a un jugador",
            ["check_player_warning"] = "Comprobar las advertencias del jugador",
            ["delete_player_warning"] = "Eliminar advertencias de los jugadores",
            ["reply_to_report"] = "Responder a un Reporte",
            ["change_ped_model"] = "Cambiar modelo de Ped",
            ["set_player_foot_speed"] = "Establecer la velocidad del pie del jugador",
            ["report_toggle"] = "Alternar reportes entrantes",
