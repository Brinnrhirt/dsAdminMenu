Locales['es'] = {
    ...
    success = {
        ...
        ["veh_repaired"] = "Vehiculo Reparado",
    },
    info = {
        ...
        ["obj"] = "Obj",
        ["ammoforthe"] = "+ Munición para la arma",
        ...
        ['entity_view_distance'] = "Distancia de visualización de la entidad establecida",
    ...
    time = {
        ...
        ["self"] = "Uno mismo",
        ["changed"] = "El tiempo ha sido cambiado",
    },
    weather = {
        ...
        ["weather_changed"] = "Clima cambiado",
    },
    commands = {
