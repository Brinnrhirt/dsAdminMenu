    ...
    Citizen.CreateThread(function()
        while EntityViewEnabled do
            ...
            if EntityFreeAim then
                DrawTitle("~y~".._U("entity_view_title").."~w~\n\n[~y~E~w~] - ".._U("entity_freeaim_delete").."~w~\n[~y~G~w~] - ".._U("entity_freeaim_freeze"), 0.15, 0.14)
                ...
                if hit and (IsEntityAVehicle(entity) or IsEntityAPed(entity) or IsEntityAnObject(entity)) then
                    ...
                    if IsControlJustReleased(0, 47) then -- Freeze entities
                        ...
                        ESX.ShowNotification(_U("you_have")..(FrozenEntities[entity] and _U("entity_frozen") or _U("entity_unfrozen")).. _U("freeaim_entity"))
                    end
                    ...
                    if IsControlJustReleased(0, 38) then -- Delete entity
                        ...
                        if not DoesEntityExist(entity) then
                            ESX.ShowNotification(_U("entity_del"))
                        else
                            ESX.ShowNotification(_U("entity_del_error"))
                        end
                    end
                else
                    FreeAimEntity = nil
